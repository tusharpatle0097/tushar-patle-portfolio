            ...
            <div className="flex flex-col md:flex-row mt-[2rem]">
                ...
                <div className="md:w-1/2  p-4 mt-8">
                    <Fade left>
                        <div className="text-center md:text-left lg:ml-[3rem]">
                            <img src={weatherImg} width={600} alt="" className='rounded-lg hover:scale-110 duration-200 border-[3px]' />
                        </div>
                    </Fade >
                </div>
                ...
                <Fade right>
                    <div className="text-center md:text-left lg:w-[85%]">
                        <h3 className={`text-[32px] font-bold mb-2 ${isDarkMode ? 'text-white' : ''} `}>Weather App</h3>
                        ...
                        <div className='px-5 lg:text-justify'>
                            <p className={`text-[17px] ${isDarkMode ? 'text-white' : ''}`}>"I developed a dynamic weather application using ReactJS and styled it with Tailwind CSS, offering a seamless and visually appealing user experience. This app utilizes live weather API integration, providing real-time updates and accurate weather forecasts. The user-friendly interface allows users to effortlessly access current weather conditions, hourly forecasts, and extended weather outlooks for any location. The ReactJS framework ensures smooth interactivity, while Tailwind CSS delivers a modern and responsive design. This project showcases my proficiency in front-end development, API integration, and creating intuitive applications that deliver live and relevant information to users."</p>
                            <div className='flex gap-[2rem] justify-center'>
                                <a href='https://weather-app-portf.vercel.app/' target='blank' className='flex gap-2 mt-3 uppercase items-center bg-[#ddedea] p-1.5 font-semibold text-black rounded-md hover:bg-gray-300 hover:scale-105 duration-200'>
                                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="lucide lucide-link"><path d="M10 13a5 5 0 0 0 7.54.54l3-3a5 5 0 0 0-7.07-7.07l-1.72 1.71"></path><path d="M14 11a5 5 0 0 0-7.54-.54l-3 3a5 5 0 0 0 7.07 7.07l1.71-1.71"></path></svg>
                                    <span>live url</span>
                                </a>
                                <a href='https://github.com/tusharpatle0097/weather-app-portf' target='blank' className='flex gap-2 mt-3 uppercase items-center bg-[#ddedea] p-1.5 font-semibold text-black rounded-md hover:bg-gray-300 hover:scale-105 duration-200'>
