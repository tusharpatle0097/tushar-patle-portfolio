                        ...
                        <div className="text-center md:text-left lg:w-[85%] lg:ml-[4rem]">
                            ...
                            <div className='px-5 lg:text-justify'>
                                ...
                                <div className='flex gap-[2rem] justify-center'>
                                    ...
                                    <a href='https://github.com/tusharpatle0097/crypto-bazar-portf' target='blank' className='flex gap-2 mt-3 uppercase items-center bg-[#ddedea] p-1.5 font-semibold text-black rounded-md hover:bg-gray-300 hover:scale-105 duration-200'>
                ...
                <div className="md:w-1/2  p-4 mt-8">
                    <Fade left>
                        <div className="text-center md:text-left lg:ml-[3rem]">
                            <video src={cryptoApp} autoPlay loop controls className='border-[3px] lg:w-[600px] rounded-lg hover:scale-110 duration-200'></video>
                        </div>
                    </Fade >
                </div>
            </div>
