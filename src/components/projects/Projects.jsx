    ...
    return (
        <>
            <div className='items-center justify-center mt-[7rem]'>
                <h3 className='text-white text-[30px]  font-semibold uppercase text-center'> projects </h3>
            ...
            <div className="flex flex-col md:flex-row mt-[2rem]">
                ...
                <div className="md:w-1/2  p-4 mt-8">
                    <div className="text-center md:text-left lg:ml-[3rem]">
                        <img src={weatherImg} width={600} alt="" className='rounded-lg hover:scale-110 duration-200' />
                    </div>
                </div>

                {/* Second Column */}
                <div className="md:w-1/2">
                    <div className="text-center md:text-left lg:w-[75%]">
                        <h3 className='text-[32px] font-bold mb-2 text-white'>Weather App</h3>
