...
const lightButton = <svg stroke="currentColor" fill="currentColor" stroke-width="0" viewBox="0 0 20 20" aria-hidden="true" className="text-primary text-2xl mr-2 " height="1em" width="1em" xmlns="http://www.w3.org/2000/svg"><path d="M17.293 13.293A8 8 0 016.707 2.707a8.001 8.001 0 1010.586 10.586z"></path></svg>
      ...
      <nav className={`flex items-center justify-between  flex-wrap p-6 ${isDarkMode ? 'bg-[#151515]' : 'bg-gradient-to-r from-indigo-500 from-10% via-sky-500 via-30% to-emerald-500 to-90%'}   text-white`}>
        ...
        <div className={`w-full block flex-grow lg:flex lg:items-center  lg:w-auto lg:text-right ${menuOpen ? 'block' : 'hidden'}`}>
          <div className="text-sm lg:flex-grow text-[17px] lg:text-center">
            <Link to='/' className="block mt-4 lg:inline-block lg:mt-0 text-white-700 font-semibold lg:hover:scale-125 duration-200  mr-6">
              HOME
            </Link>
            <Link to='/about' className="block mt-4 lg:inline-block lg:mt-0 text-white-700 font-semibold uppercase cursor-pointer lg:hover:scale-125 duration-200  mr-6">
              ABOUT
            </Link>
            <Link to='/projects' className="block mt-4 lg:inline-block lg:mt-0 text-white-700 font-semibold uppercase cursor-pointer lg:hover:scale-125 duration-200  mr-6">
              projectjs
            </Link>
            <Link to='/SuggForm' className="block mt-4 lg:inline-block lg:mt-0 text-white-700 font-semibold uppercase cursor-pointer lg:hover:scale-125 duration-200 ">
              CONTACT
            </Link>
          </div>
